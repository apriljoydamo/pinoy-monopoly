...
public class PlayersGui extends JFrame{
	...
	private JComboBox getPlayer2ComboBox() {
		if (Player2ComboBox == null) {
			...
			Player2ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer3ComboBox() {
		if (Player3ComboBox == null) {
			...
			Player3ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer4ComboBox() {
		if (Player4ComboBox == null) {
			...
			Player4ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer5ComboBox() {
		if (Player5ComboBox == null) {
			...
			Player5ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer6ComboBox() {
		if (Player6ComboBox == null) {
			...
			Player6ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer7ComboBox() {
		if (Player7ComboBox == null) {
			...
			Player7ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer8ComboBox() {
		if (Player8ComboBox == null) {
			...
			Player8ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
	...
	private JComboBox getPlayer1ComboBox() {
		if (Player1ComboBox == null) {
			...
			Player1ComboBox.setModel(new DefaultComboBoxModel(new Object[] { "item0", "item1", "item2", "item3" }));
